...
class Model(Asset):
    ...
    def from_path(path: Union[str, Path], store: Optional[bool] = None, **kwargs) -> "Model":
        ...
        return cast("Model", Asset._from_path(ctx, path, AssetType.MODEL, store, **kwargs))
    ...
    def from_cid(cid: Union[Cid, str], **kwargs) -> "Model":
        ...
        if isinstance(cid, Cid):
            return cast("Model", Asset._from_cid(ctx, cid.cid, AssetType.MODEL, **kwargs))
        else:
            return cast("Model", Asset._from_cid(ctx, cid, AssetType.MODEL, **kwargs))
    ...
    def from_object(obj: Any, store: Optional[bool] = None, **kwargs) -> "Model":
        ...
        return cast("Model", Asset._from_object(ctx, obj, AssetType.MODEL, store, **kwargs))

    @feature_gate_when_disabled(FEATURE_FLAGS.GRAPH_IDS)
    def add_attribute(self, **kwargs) -> "Model":
        self.add_attribute(**kwargs)
        return self

    @feature_gate_when_disabled(FEATURE_FLAGS.GRAPH_IDS)
    def remove_attribute(self, **kwargs) -> "Model":
