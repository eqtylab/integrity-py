...
class Config:
    ...
    @staticmethod
    def set_generate_model_signing_signatures(enable: bool) -> Config: ...
    @staticmethod
    def set_store_all_blobs(value: bool) -> Config: ...
    @staticmethod
    def get_default_context() -> Graph: ...
...
class Declaration:
    ...
    @staticmethod
    def add_attachment_cid(cid: str) -> Declaration: ...
    @staticmethod
    def add_control_cid(cid: str) -> Declaration: ...
    @staticmethod
    def add_extra(key: str, val: str) -> Declaration: ...
    @staticmethod
    def finalize() -> Declaration: ...
    @staticmethod
    def cid() -> str: ...
    @staticmethod
    def to_dict() -> Any: ...
...
class DidFactory:
    ...
    @staticmethod
    def build_from_signer(signer: Signer, **kwargs: Any) -> DID: ...
    @staticmethod
    def build_from_did_string(did: str, **kwargs: Any) -> DID: ...
...
class Graph:
    ...
    def delete() -> None: ...
    @staticmethod
    def export(path: PathLike[str]) -> None:
...
class Manifest:
    ...
    @staticmethod
    def export(file: PathLike[str]) -> None: ...
