---
title: "Assets"
description: "Assets are the main way to register inputs, outputs, documents, models, and other tracked objects in the SDK."
---

import FromObjectRef from '../../../generated/api/eqty_sdk.asset.asset.TypedAsset.from_object.mdx';
import FromPathRef from '../../../generated/api/eqty_sdk.asset.asset.TypedAsset.from_path.mdx';
import FromCidRef from '../../../generated/api/eqty_sdk.asset.asset.TypedAsset.from_cid.mdx';
import WithContextRef from '../../../generated/api/eqty_sdk.asset.asset.TypedAsset.with_context.mdx';
import BuiltInAssetTypes from '../../../generated/built-in-asset-types.mdx';
...
<Alert variant="primary" title="Use factory methods, not direct constructors">
...
builder. See [Spark Parquet Input](../examples/custom-serialize.mdx) for a
complete example.
