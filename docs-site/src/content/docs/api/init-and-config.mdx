...
description: "`init()` is the required entry point for the SDK."
---

import InitRef from '../../../generated/api/eqty_sdk.init.mdx';
import ConfigRef from '../../../generated/api/eqty_sdk._rust.Config.mdx';
import SetHashingConfigRef from '../../../generated/api/eqty_sdk._rust.Config.set_hashing_config.mdx';
import SetCidIgnoreRulesRef from '../../../generated/api/eqty_sdk._rust.Config.set_cid_ignore_rules.mdx';
import SetStoreAllBlobsRef from '../../../generated/api/eqty_sdk._rust.Config.set_store_all_blobs.mdx';
import GetDefaultContextRef from '../../../generated/api/eqty_sdk._rust.Config.get_default_context.mdx';
