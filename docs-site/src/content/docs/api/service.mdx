---
title: "Service"
description: "A service is the SDK's connection to a remote Integrity Service or Governance Studio-backed API."
---

import ServiceRef from '../../../generated/api/eqty_sdk._rust.Service.mdx';
