...
Computation.new(name="Agent 1 Compute") \
  .add_input_cid([user_prompt.cid, system_prompt.cid, model_v1.cid, agent.cid]) \
  .add_output_cid([Dataset.from_object("Output1", name="Output 1").cid]) \
  .finalize()
